...
class AAScoreAnalyzer(Executor):
    ...
    Analyzes statistical test pass rates against a target significance level (alpha),
    computes reliability weights, and selects the split with the best composite score.
    """
    ...
    def _set_value(
        ...
        """Stores analysis results under the specified key in the experiment data."""
            ...
            for col in pval_cols:
                ...
                if weight > 0:
                    ...
                    weighted_pvalues = (
                        ...
                        else weighted_pvalues + (col_data * weight)
                    )
    ...
    def execute(self, data: ExperimentData) -> ExperimentData:
        ...
        ifparam_experiment_id = data.get_ids(
            IfParamsExperiment, ExperimentDataEnum.analysis_tables
        )
