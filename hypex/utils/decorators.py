...
from hypex.utils.typings import DecoratedType, DocstringInheritDecorator


def inherit_docstring_from(source: Union[Callable[..., Any], property]) -> DocstringInheritDecorator:
    """
